...
const Sidebar = () => {
  ...
  const { selectedNetwork, networks, loading, setSelectedNetwork } = useNetwork();
    ...
    <div className="bg-gray-900 text-white w-64 min-h-screen p-4 flex flex-col">
      ...
      <div className="mt-8 pt-4 border-t border-gray-700">
        ...
        <div className="space-y-2">
          <button className="flex items-center space-x-3 px-4 py-2 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition-colors duration-200 w-full text-left">
